...
//
//
//        Properties target = .bind("spring.datasource.", Properties.class).orElse(null);
//        Map<String, Object> dsMap = new HashMap<>();
//        dsMap.put("type", target.getProperty("type"));
//        dsMap.put("driver-class-name", target.getProperty("driver-class-name"));
//        dsMap.put("url", target.getProperty("url"));
//        dsMap.put("username", target.getProperty("username"));
//        dsMap.put("password", target.getProperty("password"));
...
//        dataBinder.bind(dataSourcePropertyValues);
    ...
    private void initCustomDataSources(Environment env) {
        ...
        Properties target = Binder.get(env).bind("custom.datasource.", Properties.class).orElse(null);
        String dsPrefixs = target.getProperty("names");
        for (String dsPrefix : dsPrefixs.split(",")) {// 多个数据源
//            Map<String, Object> dsMap = target.getProperty(dsPrefix + ".");
